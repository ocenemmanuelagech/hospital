...
if($_POST && isset($_SESSION['token']) && ($_SESSION['token'] == $_POST['token'])) {
    ...
    if(isset($_GET['forget'])) {
        ...
        if(!($usr = $db->getRow("SELECT `userid`,`groupid` FROM `".MLS_PREFIX."users` WHERE `username` = ?s AND `password` = ?s", $name, sha1($password))))
            ...
            if($_POST['r'] == 1){
              ...
              //  setcookie("ugroupid", $name, time() + 3600 * 24 * 30, $path_info['path']); // set
    ...
    echo "<form class='form-horizontal well' action='#' method='post'>
        <fieldset>
            ...
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' placeholder='ocengemmanuelagech60@gmail.com' name='email' class='input-large'>
              </div>
            </div>
    ...
    echo "<form class='form-horizontal well' action='?' method='post'>
        <fieldset>
            ...
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' placeholder='Enter username' name='name' class='input-large'>
              </div>
            </div>
