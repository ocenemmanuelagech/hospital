...
//this lower code is for the drop down of the  patient
      ...
      $var[] = array("dropdown",
                      array(  0 => array("href" => "http://localhost/hospital/doc/checkapoit.php",
                                       "name" => "Check Apoitments",
                                       "class" => 0),

                            
                              1 => array("href" => "http://localhost/hospital/doc/selectpatient.php",
      ...
      $var[] = array("dropdown",
                      array(  /*0 => array("href" => "http://localhost/hospital/doc/alldocap.php",
                                       "name" => "Check all Apointments",
                                       "class" => 0),
                                       */

                              1 => array("href" => "http://localhost/hospital/doc/alldocap.php",
